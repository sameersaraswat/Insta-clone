...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        setLoading(true);
        // 1) Create a post and add to firestore 'posts' collections
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
        <Dialog
            ...
            onClose={setOpen}
    >
        <div className='flex items-end justify-content min-h-[800px] sm:min-h-screen pt-4 px-4
        ...
        >
            ...
            <Transition.Child
                ...
                leaveTo="opacity-0 translate-y-4 sm:translate-y-8 sm:scale-95"
            >
